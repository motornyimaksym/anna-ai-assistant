...
@Module({ controllers: [MediaStoreController, TelegramAccountController, HealthController, TelegramController, AdminController], providers: [MediaStoreService, TelegramAccountService, TelegramAccountStore, TelegramAccountTransport, OpenAiService, FirebaseAdminService, AdminAuthService, AdminGuard, AdminOwnerGuard, BookingRepository, CalendarService, BookingService, AvailabilityService, TelegramService, AssistantToolsService, ServicePhotoService, SpecService] }) export class AppModule {}
