import { assistantPromptResponseSchema, availableSlotsResponseSchema, bookingSchema, botSettingsResponseSchema, conversationSchema, serviceSchema, specResponseSchema, type BotSettings } from '@booking/contracts';
