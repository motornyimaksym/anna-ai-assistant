...
describe('Telegram account settings', () => {
  it('requires consent and international phone before starting', async () => {
    ...
    show();
    expect(await screen.findByText(/reads the five newest text messages from the selected schedule chat at most once every five minutes/)).toBeTruthy();
...
vi.mock('./ScheduleSourceSettings.js', () => ({ ScheduleSourceSettings: () => null }));
